...
<body class="bg-purple">
        ...
        <div class="stars">
            ...
            <div class="central-body">
                ...
                <br><button class="btn btn-primary btn-lg" onclick="location.href='../HTML_elements/admin_pages/configurationPanel.php'">Retour</button>
...
.bg-purple{
    background-image: linear-gradient(to left bottom, #000413, #050d24, #031335, #011747, #071958);
